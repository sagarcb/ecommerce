...
@section('title', 'Add Useful Links')
@section('pageTitle') <a href="{{route('useful.links.add')}}">Add Useful Links</a> @endsection
...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" action="{{ route('useful.links.store') }}" id="myform" enctype="multipart/form-data">
                @csrf
                <div class="form-row col-md-10">
                    <label for="description">Name</label>
                    <input type="text" id="name" class="form-control" name="name" placeholder="Useful Link name" required>
